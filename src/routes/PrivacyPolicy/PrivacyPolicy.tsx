...
const PrivacyPolicy: FunctionComponent = () => (
  <div className="privacy">
    <h1>Privacy Policy for Guardians of Adelia</h1>

    <p>
      At Guardians of Adelia, accessible from https://www.guardiansofadelia.com, one of our main
      priorities is the privacy of our visitors. This Privacy Policy document contains types of
      information that is collected and recorded by Guardians of Adelia and how we use it.
    </p>
    ...
    <p>
      ...
      website with regards to the information that they shared and/or collect in Guardians of
      Adelia. This policy is not applicable to any information collected offline or via channels
    ...
    <p>
      Guardians of Adelia follows a standard procedure of using log files. These files log visitors
    ...
    <p>
      ...
      Beacons that are used in their respective advertisements and links that appear on Guardians of
      Adelia, which are sent directly to users&apos; browser. They automatically receive your IP
    ...
    <p>
      Note that Guardians of Adelia has no access to or control over these cookies that are used by
    ...
    <p>
      Guardians of Adelia&apos;s Privacy Policy does not apply to other advertisers or websites.
    ...
    <p>
      Guardians of Adelia does not knowingly collect any Personal Identifiable Information from
